...
function defineCharacterData(context) {
	...
	data['skills']['bluff'] = new Skill( { name: 'bluff', isOrigin: true, ranks: 4 } );
	...
	data['skills']['intimidate'] = new Skill( { name: 'intimidate', isOrigin: true, ranks: 5 } );
	...
	data['skills']['ride'] = new Skill( { name: 'ride', isOrigin: true, ranks: 0 } );
	data['skills']['search'] = new Skill( { name: 'search', isOrigin: true, ranks: 3 } );
	data['skills']['sense motive'] = new Skill( { name: 'sense motive', isOrigin: true, ranks: 7 } );
	data['skills']['sneak'] = new Skill( { name: 'sneak', isOrigin: true, ranks: 3, misc: 4, 
	...
	data['skills']['tactics'] = new Skill( { name: 'tactics', isOrigin: true, ranks: 5 } );
